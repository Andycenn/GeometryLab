public class GeometryLabTest
{
    public static void main (String[] args) {
        ...
        System.out.println(geo.h(geo.k(9,7),geo.f(5,3)));
        ...
        System.out.println(geo.m(geo.k(7,9),geo.k(5,10),geo.h(4,10)));
        ...
        System.out.println(geo.cirArea(7));
        System.out.println(geo.cirArea(9));
        ...
        System.out.println(geo.cirArea(geo.k(8,5)));
        System.out.println(geo.paralArea(geo.j(9.2),geo.f(4,10)));
        System.out.println(geo.pythpotenuse(geo.f(5,10),geo.g(9,7)));
